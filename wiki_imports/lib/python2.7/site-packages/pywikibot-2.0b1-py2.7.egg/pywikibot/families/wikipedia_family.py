...
__version__ = '$Id: 1db5c1277e5d8802e8a522c8b6770dce0be8fbfb $'
...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ar', 'ko', 'ms', 'hu', 'sr', 'ro', 'tr', 'min', 'kk', 'eo', 'sk',
            'da', 'eu', 'lt', 'sh', 'bg', 'he', 'hr', 'sl', 'uz', 'et', 'vo',
            'hy', 'nn', 'gl', 'simple', 'hi', 'la', 'az', 'el', 'th', 'oc',
            'ka', 'mk', 'be', 'new', 'pms', 'tl', 'ta', 'tt', 'cy', 'te', 'lv',
            'ht', 'be-x-old', 'ur', 'sq', 'bs', 'br', 'jv', 'mg', 'lb', 'mr',
            'is', 'ml', 'pnb', 'ba', 'my', 'af', 'yo', 'ga', 'zh-yue', 'an',
            'bn', 'fy', 'tg', 'lmo', 'ce', 'cv', 'ky', 'sw', 'io', 'gu', 'ne',
            'bpy', 'scn', 'sco', 'nds', 'ku', 'ast', 'qu', 'su', 'als', 'kn',
            'am', 'gd', 'ia', 'nap', 'bug', 'ckb', 'bat-smg', 'wa', 'map-bms',
            'mn', 'arz', 'mzn', 'zh-min-nan', 'yi', 'si', 'pa', 'sah', 'vec',
            'sa', 'nah', 'bar', 'fo', 'os', 'roa-tara', 'pam', 'hsb', 'or',
            'se', 'li', 'mi', 'ilo', 'co', 'hif', 'gan', 'frr', 'bo', 'glk',
            'rue', 'bcl', 'nds-nl', 'fiu-vro', 'mrj', 'ps', 'tk', 'vls', 'gv',
            'xmf', 'mhr', 'pag', 'diq', 'km', 'zea', 'kv', 'csb', 'vep', 'hak',
            'ay', 'dv', 'so', 'nrm', 'rm', 'udm', 'zh-classical', 'sc', 'koi',
            'ug', 'stq', 'lad', 'wuu', 'lij', 'fur', 'mt', 'eml', 'as', 'pi',
            'bh', 'nov', 'gn', 'ksh', 'pcd', 'kw', 'ang', 'gag', 'szl', 'ace',
            'nv', 'ext', 'ie', 'frp', 'crh', 'mwl', 'sn', 'ln', 'dsb', 'pfl',
            'lez', 'krc', 'haw', 'pdc', 'xal', 'kab', 'rw', 'to', 'myv', 'arc',
            'kl', 'bjn', 'kbd', 'pap', 'lo', 'tpi', 'lbe', 'wo', 'jbo', 'mdf',
            'cbk-zam', 'av', 'ty', 'srn', 'bxr', 'ig', 'kg', 'na', 'tet', 'ab',
            'ltg', 'nso', 'za', 'kaa', 'zu', 'ha', 'chy', 'rmy', 'cu', 'chr',
            'tyv', 'tn', 'cdo', 'roa-rup', 'bi', 'got', 'pih', 'tw', 'sm', 'bm',
            'iu', 'ss', 'sd', 'pnt', 'ki', 'rn', 'xh', 'om', 'ts', 'ee', 'ak',
            'fj', 'ti', 'ks', 'sg', 've', 'ff', 'lg', 'cr', 'st', 'dz', 'tum',
            'ik', 'ny', 'ch',
        ]
